...
/**
 * Reader that reads KeloJSON files. See <a href="https://tools.ietf.org/html/rfc7946">RFC7946</a> for more information.
 * @since 15424
 */
public class KeloJSONReader extends GeoJSONReader {
    ...
    // private Projection projection = Projections.getProjectionByCode("EPSG:3857"); // Mercator
    ...
    protected void parseFeature(final JsonObject feature) {
        ...
        if (geometry != null && geometry.getValueType() == JsonValue.ValueType.OBJECT) {
            ...
            // parseRelation(feature, relation.asJsonObject());
    ...
    private void parseRelation(final JsonObject feature, final JsonObject relation) {
        if (relation != null) {
            String id = ((JsonString)feature.get("id")).getString();
            final Relation rel = new Relation();
            rel.setOsmId(Long.parseLong(id), VERSION, true);
            List<RelationMember> members;
            Logging.info("Processing Relation: " + rel.toString());
